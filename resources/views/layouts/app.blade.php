...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('gaya.css')}}">
        ...
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
            <div class="container">
                <a class="navbar-brand" href="{{ url('/') }}">
                    <img src="{{ asset('img/asianmoton.png')}}" alt="" width="30" height="24">
                    MOTOR
                </a>
                    ...
                    <ul class="nav nav-pills">
                        ...
                        <ul class="nav nav-underline">
                            <li class="nav-item">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ url('/jenisobat') }}">Data Jenis motor</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ url('/obat') }}">Data motor</a>
                                </li>
                                <li class="nav-item">
